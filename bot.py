...
class WelcomeMessage:
    ...
    def _get_reaction_task(self):
        ...
        text = f'{checkmark} *Reagir para comprovar visualização*'
    ...
    if user_id != None and BOT_ID != user_id:
        ...
        if text.lower() == 'start':
            ...
            client.chat_postMessage(
                channel=channel_id, thread_ts=ts, text="#inserir mensagem")
...
if __name__ == "__main__":
    ...
    ids = list_scheduled_messages('#IDS')
    delete_scheduled_messages(ids, '#IDS')
    app.run(debug=True)